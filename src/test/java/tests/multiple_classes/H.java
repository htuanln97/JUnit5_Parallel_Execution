...
public class H extends TestBase{
	private final GetByRoleOptions roleOptionsLocator = new Page.GetByRoleOptions();
	
	@Test
	public void test01() {
		System.out.println("H.test01() start => " + Thread.currentThread().getName());
		...
		System.out.println("H.test01() end => " + Thread.currentThread().getName());
	}
	
	
	@Test
	public void test02() {
		System.out.println("H.test02() start => " + Thread.currentThread().getName());
		...
		System.out.println("H.test02() end => " + Thread.currentThread().getName());
	}
	
	@Test
	public void  test03() {
		System.out.println("H.test03() start => " + Thread.currentThread().getName());
		...
		System.out.println("H.test03() end => " + Thread.currentThread().getName());
	}
}
