...
public class JUnit5Test extends TestBase{
	@Test
	public void test01() {
		System.out.println("JUnit5Test test01() start => " + Thread.currentThread().getName());
		...
		System.out.println("JUnit5Test test01() end => " + Thread.currentThread().getName());

	}
	
	@Test
	public void test02() {
		System.out.println("JUnit5Test test02() start => " + Thread.currentThread().getName());
		...
		System.out.println("JUnit5Test test02() end => " + Thread.currentThread().getName());
